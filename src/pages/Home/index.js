...
import ImgPersonajes from '../../assets/stormtrooper.png'
            ...
            <div className="content">
                ...
                <div className="spotlight">
                    <div className="card-spotlight">
                        <img src={ImgPersonajes} alt="Icone Personajes"></img>
                        <div>
                            <h1>Characters</h1>
                            <p>Here you can find information about all the characters in the Star Wars franchise.</p>
                            <Link to="/personajes">View more <FaEye /></Link>
                        </div>
                    </div>
                    ...
                    <div className="card-spotlight">
                        ...
                        <div>
                            ...
                            <Link to="/espacio-naves">View more <FaEye /></Link>
                        </div>
                    </div>
                </div>
